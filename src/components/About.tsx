...
export class About extends React.Component {
	...
	public render() {
		...
		const { body, pattern, eye, mouth, primary, secondary, tertiary, eyeColor } = this.state;
		let searchUrlStr = [body, pattern, eye, mouth, primary, secondary].join('%20');
		let kittyFindUrl = `https://www.cryptokitties.co/marketplace/sale?search=${searchUrlStr}`
		return (
			<Container>
			<Grid>
